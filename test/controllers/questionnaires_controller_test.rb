...
class QuestionnairesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create questionnaire" do
    assert_difference('Questionnaire.count') do
      post questionnaires_url, params: { questionnaire: { email: @questionnaire.email, modulardevelopment: @questionnaire.modulardevelopment, name: @questionnaire.name, projectrepo: @questionnaire.projectrepo, projecturl: @questionnaire.projecturl, usingbestpracticesforopp: @questionnaire.usingbestpracticesforopp } }
    end
  ...
  test "should update questionnaire" do
    patch questionnaire_url(@questionnaire), params: { questionnaire: { email: @questionnaire.email, modulardevelopment: @questionnaire.modulardevelopment, name: @questionnaire.name, projectrepo: @questionnaire.projectrepo, projecturl: @questionnaire.projecturl, usingbestpracticesforopp: @questionnaire.usingbestpracticesforopp } }
